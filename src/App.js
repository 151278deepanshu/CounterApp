...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-gray-700 flex-col gap-10 ">
      <div className="text-[#0398d4] font-bold  text-2xl text-center">Increment & Decrement</div>
          ...
          <button onClick={resetHandler} className="bg-[#0398d4] text-white mx-4 py-2 px-5 rounded-sm text-lg">
            Reset
          </button>
    </div>
  );
